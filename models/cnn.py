...
def my_CNN(input_shape, num_classes):
    ...
    model.add(Convolution2D(filters=20, kernel_size=(6, 6), padding='valid'))
    model.add(Activation('relu'))
    model.add(Dropout(.5))

    model.add(Dense(100, input_shape=(20,)))
    model.add(Dropout(.5))
    model.add(Dense(num_classes, input_shape=(100,)))
    model.add(GlobalAveragePooling2D())
    model.add(Activation('softmax',name='predictions'))
    return model

def tiny_CNN(input_shape, num_classes):
    ...
    model.add(Convolution2D(filters=12, kernel_size=(5, 5), padding='same'))
    model.add(BatchNormalization())
    model.add(Convolution2D(filters=12, kernel_size=(5, 5), padding='same'))
    model.add(BatchNormalization())
    model.add(Activation('relu'))
    ...
    model.add(Convolution2D(filters=24, kernel_size=(3, 3), padding='same'))
    model.add(BatchNormalization())
    model.add(Convolution2D(filters=24, kernel_size=(3, 3), padding='same'))
    model.add(BatchNormalization())
    model.add(Activation('relu'))
